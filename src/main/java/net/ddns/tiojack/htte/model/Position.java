...
public enum Position {
    ...
    RWB(RIGHT_BACK, NORMAL),
    RWBD(RIGHT_BACK, DEFENSIVE),
    RWBO(RIGHT_BACK, OFFENSIVE),
    RWBTM(RIGHT_BACK, TOWARDS_MIDDLE),
    LWB(LEFT_BACK, NORMAL),
    LWBD(LEFT_BACK, DEFENSIVE),
    LWBO(LEFT_BACK, OFFENSIVE),
    LWBTM(LEFT_BACK, TOWARDS_MIDDLE),
